...
namespace AditusBelli.Map
{
	...
	public struct WorldRecipe
	{
		...
		public float islandScale;     // BigIslands only: ~ islands across the map (lower = fewer/larger)
		public float islandThreshold; // BigIslands only: sea level of the island mask
	...
	public static class WorldRecipes
	{
		private static readonly Dictionary<WorldType, WorldRecipe> Recipes = new()
		{
            ...
            {
				WorldType.BigIslands, new WorldRecipe {
					noiseScale = 22f,
					octaves = 5,
					persistence = 0.5f,
					lacunarity = 1.46f,
